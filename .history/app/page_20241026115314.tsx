        ...
        <AnimatedSection>
          <section className="mt-32 w-full flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {[
                { title: "轻量化设计", desc: "采用轻量化设计，运行高效、资源占���低，能够快速处理智能合约的反编译和优化任务", icon: "/icons/speed.svg" },
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {contracts.map((contract, index) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-cyan-300">{contract.name || `合约 ${contract.file_name.substring(0, 6)}...`}</h3>
                  <p className="text-white mb-2 font-mono text-sm">{contract.file_name}</p>
                  <p className="text-gray-400 mb-4 text-sm">{contract.date || '未知时间'}</p>
                  <Link href={{
