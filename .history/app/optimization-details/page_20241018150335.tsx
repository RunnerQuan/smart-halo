...
//           <motion.div 
//             ref={leftRef}
//             className="flex-1 bg-gray-800 rounded-lg p-6 relative flex flex-col resize overflow-auto"
...
//             </div>
//             <textarea
//               className="w-full h-[calc(100vh-300px)] bg-gray-900 text-gray-300 p-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 resize-none"
//               value={originalCode}
...
//               </AnimatedButton>
//             </div>
//             <pre className="w-full h-[calc(100vh-300px)] bg-gray-900 text-gray-300 p-4 rounded-lg overflow-auto resize-none">
//               {optimizedCode}
//             </pre>
//           </motion.div>
//         </div>
    ...
    <main className="flex min-h-screen flex-col items-center justify-start p-8 bg-[#1A1A1A] text-white font-sans">
      ...
      <div className="mt-8 w-full max-w-7xl mx-auto">
        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8">
          <motion.div 
            ref={leftRef}
            className="flex-1 bg-gray-800 rounded-lg p-6 relative flex flex-col overflow-auto h-[calc(100vh-400px)]"
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            ...
            <textarea
              className="w-full h-[calc(100vh-400px)] bg-gray-900 text-gray-300 p-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 resize-none"
              value={originalCode}
              onChange={(e) => setOriginalCode(e.target.value)}
            ></textarea>
          </motion.div>
          ...
          >
            ...
            <pre className="w-full h-[calc(100vh-400px)] bg-gray-900 text-gray-300 p-4 rounded-lg overflow-auto resize-none">
              {optimizedCode}
            </pre>
          </motion.div>
        </div>
