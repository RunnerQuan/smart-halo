      ...
      <div className="mt-24 w-full max-w-7xl mx-auto">
        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8">
          ...
          >
            ...
            <textarea
              className="w-full h-full bg-gray-900 text-gray-300 p-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 resize-none"
              value={originalCode}
              onChange={(e) => setOriginalCode(e.target.value)}
            ></textarea>
          </motion.div>
          ...
          >
            ...
            <pre className="w-full h-full bg-gray-900 text-gray-300 p-4 rounded-lg overflow-auto resize-none">
              {optimizedCode}
            </pre>
          </motion.div>
        </div>
