...
export default function OptimizationDetails() {
  ...
  useEffect(() => {
    const getStoredData = () => {
      ...
      const storedOriginalCode = localStorage.getItem('originalCode');
      ...
      if (storedOptimizedCode) {
        ...
        console.log('Optimized code loaded');
      }
      // 清除存储的数据
      localStorage.removeItem('originalCode');
      localStorage.removeItem('optimizedCode');
    };
