          ...
          <section className="mt-32 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {[
                ...
                <motion.div
                  key={index}
                  className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl shadow-lg border border-gray-700 hover:border-purple-500 transition-all duration-300"
                  initial={{ opacity: 0, y: 50 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5, delay: index * 0.2 }}
                  whileHover={{ scale: 1.05, boxShadow: "0 10px 20px rgba(0,0,0,0.2)" }}
                >
                  <div className="bg-gradient-to-br from-purple-500 to-pink-500 rounded-full p-4 inline-block mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-purple-300 break-all">合约地址:</h3>
                  <p className="text-gray-400 mb-4 font-mono text-sm">{contract.address}</p>
                  <p className="text-gray-300 mb-4">{contract.info}</p>
                  <AnimatedButton className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-2 rounded-full hover:from-purple-600 hover:to-pink-600 transition-all duration-300">
                    查看详情
                  </AnimatedButton>
                </motion.div>
              ))}
