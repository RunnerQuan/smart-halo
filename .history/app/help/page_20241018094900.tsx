  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start p-8 bg-[#1A1A1A] text-white font-sans">
      ...
      <div className="mt-24 w-full max-w-4xl mx-auto">
        <h1 className="text-6xl font-bold mb-12 text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 font-tech">
          SmartHalo
        </h1>

        <h2 className="text-3xl font-semibold mb-8 text-cyan-300">使用指南</h2>
        ...
        <div className="space-y-8">
          {[
            ...
            <div key={index} className="bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                {step.icon}
                <h3 className="text-2xl font-semibold ml-4 text-cyan-300">{step.title}</h3>
              </div>
