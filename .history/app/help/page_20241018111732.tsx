...
export default function Help() {
  const steps = [
    ...
    { 
      title: "输入或上传合约", 
      desc: "输入合约地址或上传合约代码文件。支持多种文件格式，包括.sol, .json等。",
      icon: <FaCode className="text-4xl mb-4 text-cyan-500" />
    },
    { 
      title: "分析与优化", 
      desc: "我们的AI系统将自动分析您的合约，并应用最佳优化策略。这个过程通常只需要几秒钟。",
      icon: <FaSearch className="text-4xl mb-4 text-cyan-500" />
    },
    { 
      title: "查看优化结果", 
      desc: "优化完成后，您可以查看优化后的合约代码和详细的优化报告，了解所做的更改和性能提升。",
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start p-8 bg-[#1A1A1A] text-white font-sans">
      ...
      >
        ...
        >
          SmartHalo 是一款强大的智能合约优化工具，旨在帮助开发者提升合约性能和可读性。
          按照以下简单步骤，开始您的智能合约优化之旅。
        </motion.p>
