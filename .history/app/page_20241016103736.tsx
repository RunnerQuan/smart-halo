...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-8 bg-black text-white">
      ...
      <section className="text-center mt-32 animate-on-scroll">
      ...
      <section className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-10 w-full">
        {[
          ...
          <div key={index} className="text-center p-6 bg-gray-900 rounded-lg animate-on-scroll">
      ...
      <section className="mt-32 text-center w-full animate-on-scroll">
