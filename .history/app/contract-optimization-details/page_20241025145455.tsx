...
// import 'highlight.js/styles/github-dark.css'; // 你可以选择你喜欢的主题
...
export default function ContractOptimizationDetails() {
  ...
  const highlightSolidityCode = (code: string) => {
    ...
    // 自定义高亮 **code** 内容，设置黑色字体和荧光背景
    return highlightedCode.replace(
      /\*\*(.*?)\*\*/g,
      '<span style="background-color: yellow; color: black; padding: 2px 4px; border-radius: 3px;">$1</span>'
    );
  };
