...
export default function ContractOptimizationDetails() {
  ...
  const renderHighlightedCode = (code: string) => {
    return { __html: highlightSolidityCode(code) };
  };
          ...
          <div className="w-full flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6">
            ...
            >
              ...
              <div className="w-full h-[calc(100vh-220px)] overflow-auto">
                <pre>
                  <code
                    dangerouslySetInnerHTML={renderHighlightedCode(activeTab === 'decompile' ? decompileCode : sourceCode)}
                    className="hljs"
                  />
                </pre>
              </div>
            ...
            >
              ...
              <div className="w-full h-[calc(100vh-220px)] overflow-auto">
                <pre>
                  <code
                    dangerouslySetInnerHTML={renderHighlightedCode(optimizedCode)}
                    className="hljs"
                  />
                </pre>
              </div>
