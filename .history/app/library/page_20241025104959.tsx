      ...
      <div className="mt-24 w-full max-w-7xl mx-auto">
        ...
        >
          <input 
            ...
            className="w-full bg-gray-800 text-white rounded-full px-6 py-4 focus:outline-none focus:ring-2 focus:ring-purple-500 pl-12 text-lg shadow-lg"
            value={searchTerm}
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-purple-600">
                <th className="px-6 py-4 text-left text-lg font-bold text-white uppercase tracking-wider">合约名称</th>
                <th className="px-6 py-4 text-left text-lg font-bold text-white uppercase tracking-wider">合约地址</th>
                <th className="px-6 py-4 text-left text-lg font-bold text-white uppercase tracking-wider">部署时间</th>
              ...
              {filteredContracts.map((contract, index) => (
                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap text-center">
                    <span className="font-semibold text-lg">{contract.name || `合约 ${contract.file_name.substring(0, 6)}...`}</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-center">
                    <span className="font-mono text-base text-purple-300">{contract.file_name}</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-center">
