...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-start p-8 bg-[#1E1E1E] text-white">
        ...
        <AnimatedSection>
          <section className="flex flex-col md:flex-row items-start justify-between mt-16">
            <div className="md:w-1/2 text-left">
              <BoxReveal>
                <div>
                  <h1 className="text-5xl font-bold mb-6 text-purple-400 leading-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.05 }}
                >
                  <h3 className="text-lg font-semibold mb-2 text-purple-400 break-all">合约地址: {contract.address}</h3>
          ...
          <section className="mt-32 text-center w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                <div key={index} className="bg-gray-700 p-6 rounded-lg transform hover:scale-105 transition duration-300">
