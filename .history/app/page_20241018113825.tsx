      ...
      <div className="mt-16 w-full max-w-7xl mx-auto">
        ...
        <AnimatedSection>
          <section className="mt-32 w-full flex flex-col items-center">
            <motion.h2 
              className="text-4xl font-bold mb-12 text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 w-full"
              initial="hidden"
              animate="visible"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 w-full max-w-6xl">
              {[
                ...
                { title: "灵活定制", desc: "根据您的需求自定义优化参数和输���格式", icon: "/icons/customize.svg" }
              ].map((item, index) => (
                <motion.div
                  key={index}
        ...
        <AnimatedSection>
          <section className="mt-32 w-full flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-7xl px-4">
              {[
                ...
                <motion.div
                  key={index}
                  className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl shadow-lg overflow-hidden relative group"
                  initial={{ opacity: 0, y: 50 }}
                  animate={{ opacity: 1, y: 0 }}
