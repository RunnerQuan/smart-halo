...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-start p-8 bg-[#1E1E1E] text-white font-noto-sans">
              ...
              <BoxReveal>
                <div>
                  ...
                  <div className="flex space-x-8">
                    <PulsatingButton className="bg-purple-600 hover:bg-purple-700 rounded-full px-8 py-3">
                      开始优化
                    </PulsatingButton>
                    <PulsatingButton className="bg-purple-600 hover:bg-purple-700 rounded-full px-8 py-3">
                      使用教程
