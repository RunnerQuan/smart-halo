...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8 bg-[#1A1A1A] text-white font-sans">
      ...
      <div className="mt-16 w-full max-w-7xl mx-auto flex-grow flex flex-col justify-center"> 
        {/* 使该容器的内容垂直居中 */}

        <AnimatedSection>
          <section className="flex flex-col md:flex-row items-start justify-center mt-16"> 
            {/* 使用 justify-center 使内容水平居中 */}
            <motion.div 
              className="md:w-1/2 text-left"
              initial={{ opacity: 0, y: 50 }}
              animate={{ opacity: 1, y: 0 }}
