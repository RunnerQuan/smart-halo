...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-start p-8 bg-[#2A2A2A] text-white font-sans">
        ...
        <AnimatedSection>
          <section className="mt-32 text-center w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { address: "0x1234...", info: "合约A的详细信息" },
                { address: "0x5678...", info: "合约B的详细信息" },
                { address: "0x9abc...", info: "合约C的详细信息" },
                { address: "0xfabc...", info: "合约D的详细信息" }
              ].map((contract, index) => (
                <motion.div
                  key={index}
                  ...
                  whileHover={{ scale: 1.05 }}
                >
                  <h3 className="text-xl font-semibold mb-2 text-purple-300">合约地址: {contract.address}</h3>
