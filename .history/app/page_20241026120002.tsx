            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl">
              {contracts.map((contract, index) => (
                ...
                >
                  ...
                  />
                  <motion.div
                    className="absolute top-0 right-0 w-1 h-full bg-gradient-to-b from-blue-500 to-cyan-500"
                    initial={{ scaleY: 0 }}
                    animate={{ scaleY: 1 }}
                    transition={{ duration: 1, delay: (index * 0.1) + 1 }}
                  />
                  <motion.div
                    className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-cyan-500"
                    initial={{ scaleX: 0 }}
                    animate={{ scaleX: 1 }}
